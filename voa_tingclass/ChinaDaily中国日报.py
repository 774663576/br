...
SERVER_CONFIG = {
    ...
    'remote_path': '/home/book/tingli/china_deily'
}
base_dir='可可英语/China Daily中国日报'
def download_and_save_image(image_url, article_id):
    ...
    try:
        ...
        # 返回图片的URL
        return f"https://774663576.github.io/br_media/tingli/china_deily/img/{filename}"
...
def save_to_database(article_data, publish_date):
    ...
    try:
        ...
        with conn.cursor() as cursor:
            # 检查文章是否已存在
            check_sql = "SELECT article_id FROM china_deily WHERE article_id = %s"
...
def download_mp3(audio_url, article_id):
    ...
    try:
        ...
        return f"https://774663576.github.io/br_media/tingli/china_deily/mp3/{filename}"
...
def extract_article_info(html_content, article_url):
    ...
    try:
        ...
        article_data = {
            ...
            'url': f'http://readingstuday.top/tingli/china_deily/{article_id}.html',
