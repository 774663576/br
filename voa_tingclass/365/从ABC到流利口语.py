...
def extract_lesson_info(li_tag):
    ...
    try:
        ...
        # match = re.match(r'高频英语口语对话600段(\d+)：(.+)', text)
        match = re.search(r'(lesson\d+)', text)
...
def scrape_lessons(base_url):
    ...
    if all_lessons:
        ...
        with open('从ABC到流利口语.json', 'w', encoding='utf-8') as f:
...
def main():
    base_url = 'https://www.tingclass.net/list-6297'
